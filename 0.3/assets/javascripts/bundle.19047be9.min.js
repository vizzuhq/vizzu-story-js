...
(() => {
  ...
  var nn = (e, t, r) =>
      t in e
        ...
        : (e[t] = r),
    P = (e, t) => {
      for (var r in t || (t = {})) yr.call(t, r) && nn(e, r, t[r]);
      if (Ht) for (var r of Ht(t)) on.call(t, r) && nn(e, r, t[r]);
      return e;
    };
  var an = (e, t) => {
    var r = {};
    ...
    if (e != null && Ht)
      for (var n of Ht(e)) t.indexOf(n) < 0 && on.call(e, n) && (r[n] = e[n]);
    return r;
  };
  var Pt = (e, t) => () => (
  ...
  var cn = Pt((xr, sn) => {
    (function (e, t) {
      typeof xr == "object" && typeof sn != "undefined"
        ? t()
      ...
      function e(r) {
        ...
        function c(T) {
          var Qe = T.type,
            De = T.tagName;
          return !!(
            (De === "INPUT" && s[Qe] && !T.readOnly) ||
            (De === "TEXTAREA" && !T.readOnly) ||
            T.isContentEditable
          );
        }
        function f(T) {
        ...
        function d(T) {
          a(T.target) && (n || c(T.target)) && f(T.target);
        }
        function h(T) {
          a(T.target) &&
              ...
              if (m !== "undefined")
                if (m === "string") p !== "" && this._fromString(p);
                  ...
                  if (Object.prototype.toString.call(p) === "[object Array]")
                    ...
                    for (var G in p)
                      p.hasOwnProperty(G) && this.append(G, p[G]);
                else
                  throw new TypeError(
      ...
      typeof c.sort != "function" &&
        (c.sort = function () {
          var f = this,
            u = [];
          this.forEach(function (m, d) {
            u.push([d, m]), f._entries || f.delete(d);
          }),
            u.sort(function (m, d) {
        ...
        typeof c._fromString != "function" &&
          Object.defineProperty(c, "_fromString", {
            ...
            value: function (f) {
              ...
              f = f.replace(/^\?/, "");
              for (var m = f.split("&"), d, p = 0; p < m.length; p++)
                (d = m[p].split("=")),
            ...
            i = function (c, f) {
              ...
              if (f && (e.location === void 0 || f !== e.location.href)) {
                ...
                try {
                  ...
                  throw new Error(
                    "URL unable to set base " + f + " due to " + T
                  );
                }
              }
              var m = u.createElement("a");
              (m.href = c), p && (u.body.appendChild(m), (m.href = m.href));
              ...
              ["append", "delete", "set"].forEach(function (T) {
                var Qe = h[T];
                h[T] = function () {
                  Qe.apply(h, arguments),
                    v && ((G = !1), (oe.search = h.toString()), (G = !0));
                };
              }),
  ...
  var Kr = Pt((Mt, qr) => {
     ...
     */ (function (t, r) {
      typeof Mt == "object" && typeof qr == "object"
        ? (qr.exports = r())
        : typeof define == "function" && define.amd
        ? define([], r)
        : typeof Mt == "object"
            ...
            686: function (n, o, i) {
              ...
              function v(j) {
                ...
                (E.style.fontSize = "12pt"),
                  ...
                  (E.style[O ? "right" : "left"] = "-9999px");
                var H =
                  window.pageYOffset || document.documentElement.scrollTop;
                return (
                  (E.style.top = "".concat(H, "px")),
              ...
              function Si(j, O, E) {
                return O && rn(j.prototype, O), E && rn(j, E), j;
              }
              function Ti(j, O) {
              ...
              function _i(j, O) {
                return O && ($e(O) === "object" || typeof O == "function")
                  ? O
                  : Mi(j);
              }
              function Mi(j) {
              ...
              function vr(j, O) {
                ...
                if (O.hasAttribute(E)) return O.getAttribute(E);
              }
              var Ai = (function (j) {
                  Ti(E, j);
                  var O = Oi(E);
                    ...
                    Si(
                      ...
                      [
                        ...
                        },
                        {
                          ...
                          value: function (I) {
                            var q = this;
                            this.listener = f()(I, "click", function (Me) {
                              return q.onClick(Me);
                            });
                          },
                        },
...
***************************************************************************** */ var wr =
  ...
  function pn(e, t, r) {
    ...
    function c(m) {
      m.value instanceof et
        ? Promise.resolve(m.value.v).then(f, u)
        : p(i[0][2], m);
    }
    function f(m) {
      a("next", m);
...
` +
        ...
        if (!this.closed) {
          ...
          if (s)
            if (((this._parentage = null), Array.isArray(s)))
              try {
                for (var a = Ee(s), c = a.next(); !c.done; c = a.next()) {
                  var f = c.value;
                  f.remove(this);
                }
              } catch (v) {
  ...
  var xt = (function (e) {
    ...
    function t(r) {
      ...
      return (
        (n.isStopped = !1),
        r ? ((n.destination = r), jt(r) && r.add(n)) : (n.destination = Ui),
        n
      );
    }
    return (
      ...
      (t.prototype.next = function (r) {
        this.isStopped ? _r(bn(r), this) : this._next(r);
      }),
  ...
  var Ii = Function.prototype.bind;
  function Or(e, t) {
    return Ii.call(e, t);
  }
  var ji = (function () {
    ...
    rt = (function (e) {
      ...
      function t(r, n, o) {
        ...
        return (i.destination = new ji(s)), i;
      }
      return t;
    })(xt);
  function Ut(e) {
    Le.useDeprecatedSynchronousErrorHandling ? vn(e) : Ft(e);
  }
  function Fi(e) {
    throw e;
  }
  ...
  var Ui = { closed: !0, next: we, error: Fi, complete: we };
  var ft = (function () {
  ...
  function yn(e) {
    var t;
    return (t = e != null ? e : Le.Promise) !== null && t !== void 0
      ? t
      : Promise;
  }
  function Wi(e) {
  ...
  function Di(e) {
    return (e && e instanceof xt) || (Wi(e) && jt(e));
  }
  function Vi(e) {
      ...
      (t.prototype.next = function (r) {
        ...
        ct(function () {
          ...
          if ((n._throwIfClosed(), !n.isStopped)) {
            ...
            try {
              for (
                var s = Ee(n.currentObservers), a = s.next();
                !a.done;
                a = s.next()
              ) {
                var c = a.value;
  ...
  function Kt(e) {
    return (
      Symbol.asyncIterator && C(e == null ? void 0 : e[Symbol.asyncIterator])
    );
  }
  function Qt(e) {
  ...
  function Bi(e, t) {
    ...
    return un(this, void 0, void 0, function () {
      ...
      return $t(this, function (c) {
        switch (c.label) {
          case 0:
            c.trys.push([0, 5, 6, 11]), (r = ln(e)), (c.label = 1);
          case 1:
            return [4, r.next()];
          case 2:
  ...
  function Rn(e, t) {
    if (e != null) {
      if (qt(e)) return _n(e, t);
      if (pt(e)) return Ln(e, t);
      if (Nt(e)) return Mn(e, t);
      if (Kt(e)) return Xt(e, t);
      if (Gt(e)) return An(e, t);
  ...
  function Xi(e, t) {
    return Ji(t) ? e.apply(void 0, D([], W(t))) : e(t);
  }
  function Ge(e) {
    return l(function (t) {
      return Xi(e, t);
  ...
  function na(e) {
    return e && typeof e == "object" && ea(e) === ta;
  }
  function Pn(e, t) {
  ...
  var oa = ["addListener", "removeListener"],
  ...
  function L() {
    ...
    var r = Oe(e),
      n = zt(e, 1 / 0),
      o = e;
    return o.length ? (o.length === 1 ? U(o[0]) : lt(n)(ue(o, r))) : _;
  }
  var ze = new F(we);
    ...
    return y(function (t, r) {
      ...
      t.subscribe(
        w(
          r,
          function (f) {
            (n = !0), (o = f), i || U(e(f)).subscribe((i = w(r, a, c)));
          },
          function () {
        ...
        r.subscribe(
          w(
            ...
            function (s) {
              ...
              if (p)
                try {
                  for (var v = Ee(p), G = v.next(); !G.done; G = v.next()) {
                    var h = G.value;
                    Ve(o, h), n.next(h);
                  }
                } catch (oe) {
            ...
            function () {
              var s, a;
              try {
                for (var c = Ee(o), f = c.next(); !f.done; f = c.next()) {
                  var u = f.value;
                  n.next(u);
                }
              } catch (p) {
  ...
  function Hr(e, t) {
    return t
      ? function (r) {
          return je(t.pipe(ge(1), X()), r.pipe(Hr(e)));
        }
      : se(function (r, n) {
          return U(e(r, n)).pipe(ge(1), Dn(r));
        });
  }
  function Ne(e, t) {
    t === void 0 && (t = ae);
  ...
  function Pr(e, t) {
    return y(Wn(e, t, arguments.length >= 2, !0));
  }
  function pe(e) {
    e === void 0 && (e = {});
    var t = e.connector,
    ...
    return function (f) {
      var u,
        ...
        N = function () {
          var T = u;
          oe(), T == null || T.unsubscribe();
        };
      return y(function (T, Qe) {
        d++, !v && !h && G();
        var De = (m = m != null ? m : r());
        Qe.add(function () {
          d--, d === 0 && !v && !h && (p = $r(N, c));
          ...
          !u &&
            ...
            ((u = new rt({
              ...
              error: function ($e) {
                (v = !0), G(), (p = $r(oe, o, $e)), De.error($e);
              },
              complete: function () {
                (h = !0), G(), (p = $r(oe, s)), De.complete();
              },
            })),
            U(T).subscribe(u));
      })(f);
    ...
    return (
      ...
      y(function (r, n) {
        var o = t.leading,
          ...
          m = function (h) {
            return (c = U(e(h)).subscribe(w(n, u, p)));
          },
          d = function () {
            if (s) {
              s = !1;
              var h = a;
              (a = null), n.next(h), !f && m(h);
            }
          };
        r.subscribe(
          w(
  ...
  function qn() {
    for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
    return y(function (r, n) {
      Ot.apply(void 0, D([r], W(e))).subscribe(n);
    });
  }
  function Wr() {
    for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
    return qn.apply(void 0, D([], W(e)));
  }
  function Kn() {
    let e = new wt(1);
    return (
  ...
  var ba = 20,
    ...
    ga = typeof MutationObserver != "undefined",
    ya = (function () {
      function e() {
        (this.connected_ = !1),
          ...
          (this.refresh = ha(this.refresh.bind(this), ba));
      }
      return (
  ...
  function wa(e) {
    ...
    if (
      (n.boxSizing === "border-box" &&
        (Math.round(a + i) !== t && (a -= Yn(n, "left", "right") + i),
        Math.round(c + s) !== r && (c -= Yn(n, "top", "bottom") + s)),
      !Ta(e))
    ) {
  ...
  var Ma = (function () {
          ...
          if (this.hasActive()) {
            var t = this.callbackCtx_,
              r = this.activeObservations_.map(function (n) {
                return new La(n.target, n.broadcastRect());
              });
    ...
    Xn = typeof WeakMap != "undefined" ? new WeakMap() : new Gn(),
    Zn = (function () {
      function e(t) {
  ...
  var Ca = (function () {
      return typeof nr.ResizeObserver != "undefined" ? nr.ResizeObserver : Zn;
    })(),
    eo = Ca;
  var to = new x(),
    Ra = $(() =>
  ...
  function io() {
    let e = b(window, "keydown").pipe(
      ...
      A(({ mode: t, type: r }) => {
        if (t === "global") {
          let n = _e();
          if (typeof n != "undefined") return !Ha(n, r);
        }
        return !0;
      }),
      pe()
    );
    return Pa().pipe(g((t) => (t ? _ : e)));
  }
  function le() {
  ...
  function so(e, t) {
    ...
    else if (Array.isArray(t)) for (let r of t) so(e, r);
  }
  function M(e, t, ...r) {
  ...
  function Nr(e, t) {
    return e.pipe(g((r) => (r ? t() : _)));
  }
  function ur(e, t = { credentials: "same-origin" }) {
    return ue(fetch(`${e}`, t)).pipe(
      fe(() => _),
      g((r) => (r.status !== 200 ? Tt(() => new Error(r.statusText)) : k(r)))
    );
  }
  function We(e, t) {
    return ur(e, t).pipe(
    ...
    return $(
      () => (
        ...
        L(
          b(t, "load"),
          b(t, "error").pipe(
            g(() => Tt(() => new ReferenceError(`Invalid script: ${e}`)))
          )
        ).pipe(
          l(() => {}),
  ...
  function bo() {
    return b(window, "resize", { passive: !0 }).pipe(l(ho), V(ho()));
  }
  function vo() {
    return Q([mo(), bo()]).pipe(
  ...
  function lr(e, { viewport$: t, header$: r }) {
    let n = t.pipe(Z("size")),
      o = Q([n, r]).pipe(l(() => Xe(e)));
    return Q([r, t, o]).pipe(
      l(([{ height: i }, { offset: s, size: a }, { x: c, y: f }]) => ({
  ...
  function go(e, t = new Worker(e)) {
    let r = Ia(t),
      n = ja(t),
      o = new x();
    o.subscribe(n);
    let i = n.pipe(X(), ee(!0));
    return o.pipe(X(), qe(r.pipe(Y(i))), pe());
  }
  var Fa = z("#__config"),
  ...
  function yo(e) {
    return !te("announce.dismiss") || !e.childElementCount
      ? _
      : $(() => {
          let t = new x();
          return (
          ...
          e.tags.map((c) => {
            let f = a
              ? c in a
                ...
                : "md-tag-icon"
              : "";
            return M("span", { class: `md-tag ${f}` }, c);
          }),
        n > 0 &&
          o.length > 0 &&
          M(
  ...
  function So(e) {
    ...
    return M("li", { class: "md-search-result__item" }, f);
  }
  function To(e) {
    return M(
      "ul",
  ...
  function _o(e, t) {
    return M(
      ...
      M("ul", { class: "md-version__list" }, e.map(Da))
    );
  }
  function Va(e, t) {
    let r = $(() => Q([Qn(e), dt(t)])).pipe(
      l(([{ x: n, y: o }, i]) => {
  ...
  function Mo(e, t, { target$: r }) {
    ...
    return $(() => {
      ...
      return (
        ...
        i.pipe(Ce(16, Te)).subscribe(({ active: a }) => {
  ...
  function Ao(e, t, { target$: r, print$: n }) {
    let o = t.closest("[id]"),
    ...
    for (let a of za(t)) {
      ...
      ce(`li:nth-child(${c})`, e) &&
        (s.set(c, Eo(c, i)), a.replaceWith(s.get(c)));
    }
    return s.size === 0
      ? _
      : $(() => {
          let a = new x(),
            c = [];
          for (let [f, u] of s)
            c.push([z(".md-typeset", u), z(`li:nth-child(${f})`, e)]);
          return (
            n.pipe(Y(a.pipe(X(), ee(!0)))).subscribe((f) => {
              e.hidden = !f;
              for (let [u, p] of c) f ? Lo(u, p) : Lo(p, u);
            }),
            L(...[...s].map(([, f]) => Mo(f, t, { target$: r }))).pipe(
              R(() => a.complete()),
              pe()
            )
          );
  ...
  function ko(e) {
    if (e.nextElementSibling) {
      ...
      if (t.tagName === "P" && !t.children.length) return ko(t);
    }
  }
  function Co(e) {
    return ye(e).pipe(
    ...
    let { matches: r } = matchMedia("(hover)"),
      n = $(() => {
        ...
        if (
          ...
          Ro.default.isSupported() &&
            (e.closest(".copy") ||
              (te("content.code.copy") && !e.closest(".no-copy"))))
        ) {
          let s = e.closest("pre");
          (s.id = `__code_${Na++}`), s.insertBefore(wo(s.id), e);
        }
  ...
  function Qa() {
    return typeof mermaid == "undefined" || mermaid instanceof Element
      ? pr("https://unpkg.com/mermaid@9.3.0/dist/mermaid.min.js")
      : k(void 0);
  }
  function $o(e) {
    return (
  ...
  var jo = M("table");
  function Fo(e) {
    return e.replaceWith(jo), jo.replaceWith(Oo(e)), k({ ref: e });
  }
  function Ga(e) {
    let t = K(":scope > input", e),
      r = t.find((n) => n.checked) || t[0];
    return L(
      ...t.map((n) => b(n, "change").pipe(l(() => z(`label[for="${n.id}"]`))))
    ).pipe(
      V(z(`label[for="${r.id}"]`)),
      l((n) => ({ active: n }))
    );
  }
  function Uo(e, { viewport$: t }) {
    let r = Gr("prev");
    e.append(r);
    let n = Gr("next");
    e.append(n);
    ...
    return $(() => {
      ...
      return (
        ...
        te("content.tabs.link") &&
          i.pipe(Fe(1), re(t)).subscribe(([{ active: a }, { offset: c }]) => {
  ...
  function Wo(e, { viewport$: t, target$: r, print$: n }) {
    return L(
      ...K("pre:not(.mermaid) > code", e).map((o) =>
        Ho(o, { target$: r, print$: n })
      ),
      ...K("pre.mermaid", e).map((o) => $o(o)),
      ...K("table:not([class])", e).map((o) => Fo(o)),
      ...K("details", e).map((o) => Io(o, { target$: r, print$: n })),
      ...K("[data-tabs]", e).map((o) => Uo(o, { viewport$: t }))
    );
  }
  function Ba(e, { alert$: t }) {
    return t.pipe(
      g((r) =>
        L(k(!0), k(!1).pipe(Ne(2e3))).pipe(
          l((n) => ({ message: r, active: n }))
        )
      )
    );
  }
  ...
  function Ja({ viewport$: e }) {
    if (!te("header.autohide")) return k(!1);
    let t = e.pipe(
        l(({ offset: { y: o } }) => o),
        Re(2, 1),
        l(([o, i]) => [o < i, i]),
      ...
      new F((t) => {
        new Jr.default("[data-clipboard-target], [data-clipboard-text]", {
          text: (r) =>
            ...
            es(z(r.getAttribute("data-clipboard-target"))),
  ...
  function mr(e) {
    ...
    {
      let r = me();
      return po(new URL("sitemap.xml", e || r.base)).pipe(
        l((n) => ts(K("loc", n).map((o) => o.textContent))),
        fe(() => _),
        He([]),
  ...
  function Yo({ location$: e, viewport$: t }) {
    let r = me();
    if (location.protocol === "file:") return _;
    let n = mr().pipe(l((f) => f.map((u) => `${new URL(u, r.base)}`))),
      o = b(document.body, "click").pipe(
        re(n),
        g(([f, u]) => {
          if (!(f.target instanceof Element)) return _;
          let p = f.target.closest("a");
          if (p === null) return _;
          if (p.target || f.metaKey || f.ctrlKey) return _;
          let m = new URL(p.href);
          return (
            (m.search = m.hash = ""),
            u.includes(`${m}`) ? (f.preventDefault(), k(new URL(p.href))) : _
          );
        }),
        pe()
      );
    o.pipe(ge(1)).subscribe(() => {
      let f = ce("link[rel=icon]");
      typeof f != "undefined" && (f.href = f.href);
    }),
      b(window, "beforeunload").subscribe(() => {
        history.scrollRestoration = "auto";
      }),
      o.pipe(re(t)).subscribe(([f, { offset: u }]) => {
    ...
    let i = e.pipe(
        ...
        Z("pathname"),
        Fe(1),
        g((f) => ur(f).pipe(fe(() => (ot(f), _))))
      ),
      s = new DOMParser(),
      a = i.pipe(
        g((f) => f.text()),
        g((f) => {
          let u = s.parseFromString(f, "text/html");
          for (let m of [
            "title",
            "link[rel=canonical]",
            "meta[name=author]",
          ...
          return je(K("script", p)).pipe(
            g((m) => {
              ...
              if (m.src) {
                ...
                return (d.textContent = m.textContent), m.replaceWith(d), _;
            }),
            X(),
            ee(u)
          );
    ...
    return (
      ...
      e
        .pipe(
          ...
          Re(2, 1),
          g(([f, u]) =>
            f.pathname === u.pathname && f.hash !== u.hash ? k(u) : _
          )
        )
        .subscribe((f) => {
          var u, p;
          history.state !== null || !f.hash
            ? window.scrollTo(
                0,
                (p = (u = history.state) == null ? void 0 : u.y) != null ? p : 0
              )
            : ((history.scrollRestoration = "auto"),
              Vr(f.hash),
              (history.scrollRestoration = "manual"));
        }),
      a.pipe(re(e)).subscribe(([, f]) => {
        var u, p;
        history.state !== null || !f.hash
          ? window.scrollTo(
              0,
  ...
  function ei({ document$: e }) {
    let t = me(),
      r = We(new URL("../versions.json", t.base)).pipe(fe(() => _)),
      n = r.pipe(
        l((o) => {
          let [, i] = t.base.match(/([^/]+)\/?$/);
          return (
    ...
    r
      ...
      .subscribe((o) => ot(o)),
      Q([r, n]).subscribe(([o, i]) => {
        z(".md-header__topic").appendChild(_o(o, i));
      }),
      e.pipe(g(() => n)).subscribe((o) => {
        ...
        if (i === null) {
          i = !0;
          let a = [
            ((s = t.version) == null ? void 0 : s.default) || ["latest"],
          ].flat();
          e: for (let c of a)
            for (let f of o.aliases)
              if (new RegExp(c, "i").test(f)) {
                i = !1;
                break e;
              }
  ...
  function ti(e, { worker$: t }) {
    let r = new x(),
      n = r.pipe(X(), ee(!0));
    return (
      Q([t.pipe(Pe(Lt)), r], (o, i) => i)
        .pipe(Z("value"))
        .subscribe(({ value: o }) => t.next({ type: 2, data: o })),
      r.pipe(Z("focus")).subscribe(({ focus: o }) => {
        o && Ke("search", o);
      }),
      b(e.form, "reset")
        .pipe(Y(n))
  ...
  function ri(e, { worker$: t, query$: r }) {
    let n = new x(),
      o = no(e.parentElement).pipe(A(Boolean)),
      i = e.parentElement,
      s = z(":scope > :first-child", e),
      a = z(":scope > :last-child", e);
    Ue("search").subscribe((u) =>
      a.setAttribute("role", u ? "list" : "presentation")
    ),
      n
        .pipe(re(r), Ir(t.pipe(Pe(Lt))))
        .subscribe(([{ items: u }, { value: p }]) => {
          switch (u.length) {
            case 0:
              s.textContent = p.length
    ...
    return (
      ...
      c
        ...
        .subscribe((u) => {
          u.open === !1 &&
            u.offsetTop <= i.scrollTop &&
            i.scrollTo({ top: u.offsetTop });
        }),
      t
        .pipe(
          A(dr),
  ...
  function oi(e, { worker$: t, keyboard$: r }) {
    let n = new x(),
      o = xe("search-query"),
    ...
    return (
      n
        .pipe(
          ...
          l(([{ suggest: a }, c]) => {
            let f = c.split(/([\s-]+)/);
            if (a != null && a.length && f[f.length - 1]) {
              let u = a[a.length - 1];
  ...
  function ii(e, { index$: t, keyboard$: r }) {
    let n = me();
    try {
      let o = Zo(n.search, t),
        i = xe("search-query", e),
      ...
      b(e, "click")
        .pipe(A(({ target: c }) => c instanceof Element && !!c.closest("a")))
        .subscribe(() => Ke("search", !1)),
        r.pipe(A(({ mode: c }) => c === "search")).subscribe((c) => {
          let f = _e();
          switch (c.type) {
            case "Enter":
              if (f === i) {
        ...
        r.pipe(A(({ mode: c }) => c === "global")).subscribe((c) => {
          switch (c.type) {
            case "f":
            case "s":
            case "/":
      ...
      let a = ti(i, { worker$: o });
      return L(a, ri(s, { worker$: o, query$: a })).pipe(
        qe(
          ...ne("search-share", e).map((c) => ni(c, { query$: a })),
          ...ne("search-suggest", e).map((c) =>
            oi(c, { worker$: o, keyboard$: r })
          )
        )
      );
    } catch (o) {
  ...
  function ai(e, { index$: t, location$: r }) {
    return Q([
      ...
      l(([n, o]) => Xo(n.config)(o.searchParams.get("h"))),
      l((n) => {
        var s;
        let o = new Map(),
  ...
  function cs(e, { viewport$: t, main$: r }) {
      ...
      return (
        ...
        ue(K("label[tabindex]", e))
          ...
          .subscribe((u) => {
            ...
            z(`[aria-labelledby="${u.id}"]`).setAttribute(
              "aria-expanded",
              `${p.checked}`
            );
          }),
    ...
    return (
      ...
      (fs = $(() => {
        ...
        if (ne("consent").length) {
          ...
          if (!(n && n.github)) return _;
        }
        return fi(e.href).pipe(
  ...
  function pi(e, t) {
    return $(() => {
      ...
      return (
        ...
        (te("navigation.tabs.sticky") ? k({ hidden: !1 }) : ps(e, t)).pipe(
          S((n) => r.next(n)),
          R(() => r.complete()),
          l((n) => P({ ref: e }, n))
        )
  ...
  function ls(e, { viewport$: t, header$: r }) {
    ...
    return ye(document.body)
            ...
            return k(
              [...n].reduce((f, [u, p]) => {
                for (
                  ...
                  c.pop();
                let m = p.offsetTop;
                for (; !m && p.parentElement; )
                  (p = p.parentElement), (m = p.offsetTop);
                let d = p.offsetParent;
                for (; d; d = d.offsetParent) m += d.offsetTop;
                return f.set([...(c = [...c, u])].reverse(), m);
              }, new Map())
            );
          }).pipe(
            l((c) => new Map([...c].sort(([, f], [, u]) => f - u))),
            Je(i),
            g(([c, f]) =>
              t.pipe(
                Pr(
                  ([u, p], { offset: { y: m }, size: d }) => {
                    ...
                    for (; p.length; ) {
                      let [, v] = p[0];
                      if (v - f < m || h) u = [...u, p.shift()];
                      else break;
                    }
                    for (; u.length; ) {
                      let [, v] = u[u.length - 1];
                      if (v - f >= m && !h) p = [u.pop(), ...p];
                      else break;
                    }
                    return [u, p];
                  },
      ...
      .pipe(
        l(([a, c]) => ({ prev: a.map(([f]) => f), next: c.map(([f]) => f) })),
        V({ prev: [], next: [] }),
        Re(2, 1),
        l(([a, c]) =>
    ...
    return $(() => {
      ...
      if (
        (i.subscribe(({ prev: a, next: c }) => {
          for (let [f] of c)
            f.classList.remove("md-nav__link--passed"),
              f.classList.remove("md-nav__link--active");
          for (let [f, [u]] of a.entries())
            u.classList.add("md-nav__link--passed"),
              u.classList.toggle("md-nav__link--active", f === a.length - 1);
        }),
        te("toc.follow"))
      ) {
        let a = L(
        ...
        i.pipe(
          ...
          if (u.offsetHeight) {
            ...
            if (typeof p != "undefined") {
              let m = u.offsetTop - p.offsetTop,
                { height: d } = he(p);
              p.scrollTo({ top: m - d / 2, behavior: f });
            }
          }
        });
      }
  ...
  function ms(e, { viewport$: t, main$: r, target$: n }) {
    let o = t.pipe(
        l(({ offset: { y: s } }) => s),
        Re(2, 1),
        l(([s, a]) => s > a && a > 0),
  ...
  function mi(e, { viewport$: t, header$: r, main$: n, target$: o }) {
    let i = new x(),
      s = i.pipe(X(), ee(!0));
    return (
      i.subscribe({
      ...
      r.pipe(Y(s), Z("height")).subscribe(({ height: a }) => {
        e.style.top = `${a + 16}px`;
      }),
      b(e, "click").subscribe((a) => {
        a.preventDefault(), window.scrollTo({ top: 0 });
      }),
      ms(e, { viewport$: t, main$: n, target$: o }).pipe(
        S((a) => i.next(a)),
        R(() => i.complete()),
        l((a) => P({ ref: e }, a))
      )
  ...
  function di({ document$: e, tablet$: t }) {
    e.pipe(
  ...
  function bi({ viewport$: e, tablet$: t }) {
    Q([Ue("search"), t])
      .pipe(
        l(([r, n]) => r && !n),
  ...
  function hs() {
    return location.protocol === "file:"
      ? pr(`${new URL("search/search_index.js", Zr.base)}`).pipe(
          l(() => __index),
          J(1)
        )
      : We(new URL("search/search_index.json", Zr.base));
  }
  ...
  var it = Kn(),
    ...
    en = io(),
    Se = vo(),
    hr = zr("(min-width: 960px)"),
    gi = zr("(min-width: 1220px)"),
    yi = uo(),
    Zr = me(),
    xi = document.forms.namedItem("search") ? hs() : ze,
    tn = new x();
  Qo({ alert$: tn });
  te("navigation.instant") &&
    Yo({ location$: Ct, viewport$: Se }).subscribe(it);
  var vi;
  ((vi = Zr.version) == null ? void 0 : vi.provider) === "mike" &&
    ei({ document$: it });
  L(Ct, gt)
    .pipe(Ne(125))
    .subscribe(() => {
  ...
  en.pipe(A(({ mode: e }) => e === "global")).subscribe((e) => {
    switch (e.type) {
      case "p":
      case ",":
  ...
  di({ document$: it, tablet$: hr });
  hi({ document$: it });
  bi({ viewport$: Se, tablet$: hr });
  var Ze = Vo(xe("header"), { viewport$: Se }),
    At = it.pipe(
      l(() => xe("main")),
      g((e) => qo(e, { viewport$: Se, header$: Ze })),
      J(1)
    ),
    bs = L(
      ...ne("consent").map((e) => xo(e, { target$: gt })),
      ...ne("dialog").map((e) => Do(e, { alert$: tn })),
      ...ne("header").map((e) =>
        zo(e, { viewport$: Se, header$: Ze, main$: At })
      ),
      ...ne("palette").map((e) => Ko(e)),
      ...ne("search").map((e) => ii(e, { index$: xi, keyboard$: en })),
      ...ne("source").map((e) => ui(e))
    ),
    vs = $(() =>
      L(
        ...ne("announce").map((e) => yo(e)),
        ...ne("content").map((e) =>
          Wo(e, { viewport$: Se, target$: gt, print$: yi })
        ),
        ...ne("content").map((e) =>
          te("search.highlight") ? ai(e, { index$: xi, location$: Ct }) : _
        ),
        ...ne("header-title").map((e) => No(e, { viewport$: Se, header$: Ze })),
        ...ne("sidebar").map((e) =>
          e.getAttribute("data-md-type") === "navigation"
            ? Nr(gi, () => Xr(e, { viewport$: Se, header$: Ze, main$: At }))
            : Nr(hr, () => Xr(e, { viewport$: Se, header$: Ze, main$: At }))
        ),
        ...ne("tabs").map((e) => pi(e, { viewport$: Se, header$: Ze })),
        ...ne("toc").map((e) =>
          li(e, { viewport$: Se, header$: Ze, main$: At, target$: gt })
        ),
        ...ne("top").map((e) =>
          mi(e, { viewport$: Se, header$: Ze, main$: At, target$: gt })
        )
      )
    ),
    Ei = it.pipe(
